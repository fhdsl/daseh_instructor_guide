...
1) [**An Introduction to R**](https://daseh.org/modules/Intro/Intro.html)
    ...
    This module includes the history of how R came to be and how it differs from other options like [Python](https://www.python.org/) or [Stata](https://www.stata.com/). It prepares students for the course experience and suggestions for how to learn. It also introduces jargon such as "variable", "row", "column", and "object".
...
<iframe src="https://docs.google.com/document/d/1ZD-w0vc3Vtv1vf95h6323zaaxORg9vC7Hp4I_IUeW0I/edit?usp=sharing" width="800" height="1200px" scrolling="no"></iframe>
