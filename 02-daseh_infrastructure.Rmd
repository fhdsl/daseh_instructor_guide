...
9) Links to course resources and potentially other [resources](#resources-slide), such as [Open Case Studies](https://opencasestudies.org) or Posit Cheatsheets
...
### Example Resources Slide {#resources-slide}

```{r, fig.align='center', echo = FALSE, fig.alt = "image of a slide showing links to the website, lab, day 3 cheatsheet, and posit's dplyr cheatsheet", out.width="100%"}
ottrpal::include_slide('https://docs.google.com/presentation/d/1vCiMPvvsdwQjiMWjf0YuSpTkG0DGXsy1614cRiFc7ns/edit?slide=id.g3d44163d3ed_0_36#slide=id.g3d44163d3ed_0_36')
```
