...
All of the data used in the modules are also included in the GitHub repository. This data can be reused separately outside of our our module materials for other uses.
