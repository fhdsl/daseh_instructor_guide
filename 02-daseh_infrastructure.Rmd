...
We like to share recordings of our lectures with the students right after we record to:
...
Each one has lecture slides built using [ioslides](https://garrettgman.github.io/rmarkdown/ioslides_presentation_format.html) as well as lab activities built using [R Markdown](https://rmarkdown.rstudio.com/).
