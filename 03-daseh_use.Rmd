...
The data can also be accessed directly in R via URL, replacing `<filename>` with the name of the data file in the following pattern:

```
"https://daseh.org/data/<filename>"
```
