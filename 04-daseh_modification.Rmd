...
See the above sections about modifying the website to get the module `.Rmd` files.
...
If you want to change the style of all slides, modify the `style.css` file. For example, adding the following to the `style .css` file is how you can make slides with smaller font:
...
In the `style .css` file the following creates smaller font throughout:
