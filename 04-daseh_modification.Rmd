...
2) You can copy the files from our repository into your own website - to access the contents of the files, go to [our respository on GitHub](https://github.com/fhdsl/daseh). This allows you to use whatever website setup you would like. 

### Creating a fork of our repository

To create what is called a "fork" of our repository (which allows you to make your own version based off of ours) then look for the fork button on the upper right corner of our respository on GitHub.
...
- Go to Secrets and variables in the left sid menu
- Click on Actions
...
- Click the green add secret botton. 
...
#### Manually Download Data from GitHub:
 ...
 1) Download the .Rmd files found in the [modules directory of the GitHub repostiory](https://github.com/fhdsl/DaSEH/tree/main/modules) (and any relevant data files from the [data directory](https://github.com/fhdsl/DaSEH/tree/main/data)).
