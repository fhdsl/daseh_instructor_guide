...
```{r, fig.align='center', echo = FALSE, fig.alt = "image of the secret generation page under Select scopes, where repo and nested scopes are selected", out.width="100%"}
ottrpal::include_slide('https://docs.google.com/presentation/d/1vCiMPvvsdwQjiMWjf0YuSpTkG0DGXsy1614cRiFc7ns/edit?slide=id.g3df3e912bd5_0_0#slide=id.g3df3e912bd5_0_0')
```
...
```{r, fig.align='center', echo = FALSE, fig.alt = "image shows the file structure in the repository under modules/Statistics subdirectory, where only the Rmd file should be edited", out.width="100%"}
ottrpal::include_slide('https://docs.google.com/presentation/d/1vCiMPvvsdwQjiMWjf0YuSpTkG0DGXsy1614cRiFc7ns/edit?slide=id.g3df3e912bd5_0_11#slide=id.g3df3e912bd5_0_11')
```
...
```{r, fig.align='center', echo = FALSE, fig.alt = "image of a slide with a H1 level header to start a new section", out.width="100%"}
...
All slides will appear to you as "View Only". To create a copy that you can edit, go to "File" > "Make a copy" and select either "Entire presentation" or "Selected slides".

```{r, fig.align='center', echo = FALSE, fig.alt = "image of a view only Google Slides link, where the File to Make a copy dropdown is selected", out.width="100%"}
ottrpal::include_slide('https://docs.google.com/presentation/d/1vCiMPvvsdwQjiMWjf0YuSpTkG0DGXsy1614cRiFc7ns/edit?slide=id.g3df3e912bd5_0_20#slide=id.g3df3e912bd5_0_20')
```
